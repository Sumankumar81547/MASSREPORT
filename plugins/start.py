...
async def handle_start(bot:Client, message:Message):
    ...
    Btn = [
        ...
        [InlineKeyboardButton(text='🌻Uᴘᴅᴀᴛᴇs', url='https://t.me/R_I_S_I_NG'), InlineKeyboardButton(text='🌨️Aʙᴏᴜᴛ', callback_data='about')],
        [InlineKeyboardButton(text='❄️Dᴇᴠᴇʟᴏᴘᴇʀ', url='https://t.me/R_I_S_I_NG')]
        ]
